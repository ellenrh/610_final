...
ggplot(aes(feeling_of_happiness, n))+
  ...
  labs(title = "Feeling of happiness by state of health",
       x = "Feeling of happniess",
       y = "Number of people",
       caption = "Survey of more than 86,000 people across the world. Source: WVS 2012") +
    theme_minimal() +
...
Study of happiness and its causal factors has been flourished in recent years. This project explores the relationship between happiness and some candidate variables, namely level of income, statues of heath, level of trust... (add more later). We use individual level survey of more than 86,000 respondents across ... country in World Value Survey (citation here). 
>>>>>>> Stashed changes
