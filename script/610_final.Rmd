...
# Why does this still include "Don't know" and "HT: Dropped..." even though we recoded these as "Other" and then in the data_2 oject we filtered "Other" out??

```


```{r happiness variable recoded as numbers}
...
# Still need to figure out how to make happiness numeric in order to calculate mean happiness. 
